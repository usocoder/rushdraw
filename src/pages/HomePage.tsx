  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold mb-3">Comprehensive A-Z System</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold mb-3">Industry Resources</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-white p-5 rounded-lg shadow border-l-4 border-blue-500">
                  ...
                  <p>Goal setting and motivational planning ensures the necessary skills and mindset to define key objectives, stay motivated, and set the foundation for success.</p>
                </div>
                
                <div className="bg-white p-5 rounded-lg shadow border-l-4 border-blue-500">
                  <h3 className="font-semibold mb-2">Risks and Opportunities</h3>
                  <p>General economic and property specific risks you need to know when embarking on a development project. Learn about property cycles, how to mitigate risks and reveal opportunities.</p>
                </div>
                
                <div className="bg-white p-5 rounded-lg shadow border-l-4 border-blue-500">
                  <h3 className="font-semibold mb-2">Research and Due Diligence</h3>
                  <p>Master the art of finding lucrative development sites and conducting thorough due diligence research for profitable project identification.</p>
                </div>
                
                <div className="bg-white p-5 rounded-lg shadow border-l-4 border-blue-500">
                  <h3 className="font-semibold mb-2">Valuation of a Development Project</h3>
                  <p>Learn valuation methodology and its application to create a framework, build a feasibility model, and ensure the best outcome.</p>
                </div>
                
                <div className="bg-white p-5 rounded-lg shadow border-l-4 border-green-500">
                  <h3 className="font-semibold mb-2">Property Development Budgets</h3>
                  <p>Comprehend cost considerations at different project stages and effectively manage cash flow throughout the entire project.</p>
                </div>
                
                <div className="bg-white p-5 rounded-lg shadow border-l-4 border-green-500">
                  <h3 className="font-semibold mb-2">Project Funding</h3>
                  <p>Explore funding options for property development projects, and strategies to minimise or eliminate personal equity contributions.</p>
                </div>
              </div>
      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-10">Who Is This Course For?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">Complete Beginners</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">Property Investors</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">Experienced Developers</h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6">Ready to Start Your Property Development Journey?</h2>
